    ...
    <Grid minH={'100vh'} templateColumns={['1fr','5fr 1fr']}>
        <Box boxSizing='border-box' py='16' px={['4','0']}>
          ...
          <Stack direction={['column','row']} minH={'24'} justifyContent={'space-evenly'}>
            <Databox title="Views" qty={123} qtyPercentage={40} profit={true} />
            <Databox title="Users" qty={29} qtyPercentage={88} profit={true} />
            <Databox title="Subscription" qty={9} qtyPercentage={20} profit={false} />
          </Stack>
          ...
          <Grid templateColumns={['1fr','2fr 1fr']}>
            <Box p='4'>
              ...
              <Box>
                <Bar profit={true} title='veiws' value={40} />
                <Bar profit={true} title='users' value={88} />
